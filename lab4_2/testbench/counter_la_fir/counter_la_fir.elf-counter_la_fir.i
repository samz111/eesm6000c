...
# 130 "counter_la_fir.c"
 int i;
 int* tmp = fir();
 (*(volatile uint32_t*)0x2600000c) = 0x005A0000;

 for (i=0; i<65; i++){
         (*(volatile uint32_t*)0x2600000c) = *(tmp+i) << 16;
 ...
 for (int i=0; i<65; i++){
         (*(volatile uint32_t*)0x2600000c) = *(tmpp+i) << 16;
     }
 ...
 for (int i=0; i<65; i++){
         (*(volatile uint32_t*)0x2600000c) = *(tmppp+i) << 16;
