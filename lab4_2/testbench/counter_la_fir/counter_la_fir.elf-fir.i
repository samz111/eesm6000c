# 0 "fir.c"
# 1 "/home/ubuntu/Desktop/hkust-soc-lab-main/Lab4/Lab4-2/lab-caravel_fir/testbench/counter_la_fir//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "fir.c"
# 1 "../../firmware/defs.h" 1
...
void __attribute__ ( ( section ( ".mprjram" ) ) ) initfir() {
 ...
 (*(volatile uint32_t*)0x30000080) = taps[0];
 (*(volatile uint32_t*)0x30000084) = taps[1];
 (*(volatile uint32_t*)0x30000088) = taps[2];
 (*(volatile uint32_t*)0x3000008c) = taps[3];
 (*(volatile uint32_t*)0x30000090) = taps[4];
 (*(volatile uint32_t*)0x30000094) = taps[5];
 (*(volatile uint32_t*)0x30000098) = taps[6];
 (*(volatile uint32_t*)0x3000009c) = taps[7];
 (*(volatile uint32_t*)0x300000a0) = taps[8];
 (*(volatile uint32_t*)0x300000a4) = taps[9];
 (*(volatile uint32_t*)0x300000a8) = taps[10];
...
int* __attribute__ ( ( section ( ".mprjram" ) ) ) fir(){
 ...
 for (i=0; i<64;){
  (*(volatile uint32_t*)0x30000040) = i+1;
  i++;
  outputsignal[i] = (*(volatile uint32_t*)0x30000044);
 }
